...
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-area-chart"></i> Electricity Production Example</div>
    <div class="card-body">
...
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-area-chart"></i> Electricity Buy Example</div>
    <div class="card-body">
        <canvas id="buyChart" width="100%" height="30"></canvas>
    </div>
    <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
</div>
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-area-chart"></i> Electricity Discharge Example</div>
    <div class="card-body">
        <canvas id="dischargeChart" width="100%" height="30"></canvas>
    </div>
    <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
</div>
<script>
    ...
    var ctx = document.getElementById("buyChart");
    var myLineChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["Mar 1", "Mar 2", "Mar 3", "Mar 4", "Mar 5", "Mar 6", "Mar 7", "Mar 8", "Mar 9", "Mar 10"],
    ...
    var ctx = document.getElementById("dischargeChart");
    var myLineChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["Mar 1", "Mar 2", "Mar 3", "Mar 4", "Mar 5", "Mar 6", "Mar 7", "Mar 8", "Mar 9", "Mar 10"],
